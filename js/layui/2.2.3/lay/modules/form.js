        ...
        var n = this, c = i(s + function () {
            ...
            select: function () {
                ...
                a.each(function (a, l) {
                    ...
                    if ("string" == typeof s.attr("lay-ignore")) return s.show();
                    if(l.alt!=''){
                        var c = i(['<div class="layui-unselect ' + e + (l.checked ? " " + e + "ed" : "") + (u ? " layui-radio-disbaled " + o : "") + '">', '<i class="layui-anim layui-icon">' + t[l.checked ? 0 : 1] + "</i>", "<span>" + (l.title || "未命名") + "</span><span class='layui-badge'>"+l.alt+"</span>", "</div>"].join(""));
                    }else{
